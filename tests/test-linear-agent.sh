...
assert_contains "$SKILL_DIR/SKILL.md" "Standard validation is mandatory for every project"
assert_contains "$SKILL_DIR/SKILL.md" "Do you want standard validation only"

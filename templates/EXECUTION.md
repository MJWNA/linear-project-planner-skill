# Linear Execution Ledger: <Project Name>

## Original Prompt

<Paste the user request or project brief that caused this Linear project to be created.>

## Source Of Truth

- Linear project:
- Operating guide issue:
- Verification matrix issue:
- Repository:
- Base branch:
